        ...
        <SafeAreaView className="flex-1 bg-plomo-200">
            ...
            >
                <View className="items-center mb-10">
                    ...
                    <Text className="text-gray-500 mt-2 text-base text-center">Inicia sesión para continuar</Text>
                </View>
                ...
                <View className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                    ...
                    <TouchableOpacity
                        className="bg-orange-600 rounded-2xl py-4 items-center shadow-md"
                        onPress={login}
                    >
                    ...
                    <TouchableOpacity
                        className="border border-orange-600 mt-4 rounded-2xl py-2 items-center"
                        onPress={() => navigation.navigate('Register')}
                    >
                        <Text className="text-orange-600 font-bold text-lg">Crear cuenta</Text>
                    </TouchableOpacity>
